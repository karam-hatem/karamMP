...
<form method="POST" action="{{ route('restaurant.update', $restaurant->id) }}" enctype="multipart/form-data" class="container">
    ...
    <div class="row">
        ...
        <div class="form-group">
          ...
          {{--   اذا كان المستخدم ادمن ويريد ان يعدل على احدى المطاعم--}}
          @auth
            @if(auth()->user()->role =='admin')   
            <select name="user_id" class="btn btn-warning"style="margin:10px" >
          ...
          @endauth
            ...
            <input type="file" id="image" name="image" class="btn btn-secondary" >
